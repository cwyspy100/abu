...
class AbuDoubleMaBuyNew(AbuFactorBuyXD, BuyCallMixin):
    ...
    def _init_self(self, **kwargs):
        ...
        super(AbuDoubleMaBuyNew, self)._init_self(**kwargs)
    ...
    def fit_day(self, today):
        ...
        slow_bf_yesterday = slow_line[-3]

        num1 = slow_today - today.close
        num2 = slow_yesterday - yesterday.close
        num3 = slow_bf_yesterday - bf_yesterday.close

        # ang = ABuRegUtil.calc_regress_deg(self.xd_kl.close, show=False)
