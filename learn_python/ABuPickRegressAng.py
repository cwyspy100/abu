...
class AbuPickRegressAng(AbuPickStockBase):
    """拟合角度选股因子示例类"""
    ...
    def _init_self(self, **kwargs):
        ...
        # if 'ma_slow' in kwargs:
        #     self.ma_slow = kwargs['ma_slow']
    ...
    def fit_pick(self, kl_pd, target_symbol):
        ...
        # 计算慢线
        slow_line = calc_ma_from_prices(self.xd_kl.close, int(self.xd), min_periods=1)

        # 计算走势角度
        ang = ABuRegUtil.calc_regress_deg(slow_line, show=False)
